...
EMSCRIPTEN_BINDINGS(EnumClasses)
{
    ...
    enum_<Opt>("Opt")
        ...
        .value("OPT_LA_PROBE2", Opt::LA_PROBE2)
        .value("OPT_LA_PROBE3", Opt::LA_PROBE3)
...
EMSCRIPTEN_BINDINGS(Keys)
{
    ...
    */
    ...
    constant("OPT_LOCK_DSKSYNC", (int)Opt::DC_LOCK_DSKSYNC);
    constant("OPT_AUTO_DSKSYNC", (int)Opt::DC_AUTO_DSKSYNC);
